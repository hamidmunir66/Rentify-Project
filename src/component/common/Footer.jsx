        ...
        <div className="max-w-8xl mx-auto px-6 sm:px-10 pt-12 pb-6">
          ...
          <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                <Link className="social-hover inline-flex items-center justify-center h-10 w-10 rounded-lg bg-linear-to-br from-indigo-500 to-blue-500 shadow-md transition">
                  <FontAwesomeIcon icon={faFacebookF} />
                </Link>

                <Link className="social-hover inline-flex items-center justify-center h-10 w-10 rounded-lg bg-linear-to-br from-sky-500 to-indigo-500 shadow-md transition">
                  <FontAwesomeIcon icon={faTwitter} />
                </Link>

                <Link className="social-hover inline-flex items-center justify-center h-10 w-10 rounded-lg bg-linear-to-br from-pink-500 to-rose-500 shadow-md transition">
