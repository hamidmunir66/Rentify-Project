  ...
  return (
    <div className="px-8 py-16 bg-gray-50">
      <div className="flex flex-col mb-8 justify-center">
        <h1 className="text-3xl font-semibold px-2 mx-2 my-1">
          Featured Listings
        </h1>
        ...
        <div className="flex justify-between px-2 mx-2">
          ...
          <button className="text-blue-600 font-medium flex items-center gap-4 cursor-pointer">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 p-6">
        {featuredListings.map((lis) => (
          <div
            key={lis.id}
            className="group bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden relative"
          >
            <div className="relative overflow-hidden">
              ...
              <button className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-blue-600 text-white px-4 py-2 rounded-lg font-medium opacity-0 group-hover:opacity-100 transition-all duration-300 shadow-lg">
                <Link to={`/product/${lis.id}`}>View Details</Link>
              </button>
            </div>
            ...
            <div className="p-4">
              ...
              <div className="text-blue-600 font-medium mt-2">
                ₹{lis.priceDay}/Day
                <span className="text-gray-500"> • ₹{lis.priceWeek}/Week</span>
              </div>
