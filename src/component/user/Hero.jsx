            ...
            <div className="w-full grid grid-cols-2 gap-3 px-8 py-6">
                ...
                <div className='left-hero  '>
                    ...
                    <div className=' space-y-2 my-10 py-10 mx-6 px-8'>
                        ...
                        <h1 className='text-6xl font-bold'>Items Into <span className='text-blue-600'>Income</span> </h1>
                        <h2 className='font-semibold '>Rent Anything. <span className='px-1 text-blue-600'>Anytime.</span> <span>Near <span className='text-blue-600'>You.</span></span> </h2>
                        <div>
                            <p className='font-medium py-1'>
                                Join Pakistan's most trusted peer-to-peer rental marketplace. Rent what you need, earn from what you own.
                            </p>
                        </div>
                    </div>
                    {/* Search Bar */}
                        ...
                        <div className='bg-white flex items-center rounded-2xl shadow-lg px-6 py-3 w-[95%] max-w-4xl border border-gray-200'>
                            ...
                            {/* Input Field */}
                            <input type="text" placeholder='What are you looking for?' className='ml-4 focus:outline-none w-full text-gray-700 ' />
                            {/* Divider */}
                            <div className="border-r border-gray-300 h-8 mx-4"></div>
                            {/* Location Input */}
                            <FontAwesomeIcon icon={faLocationDot} className="text-gray-500 text-xl" />
                            <input type="text" placeholder='Location' className='ml-3 w-32 focus:outline-none text-gray-700' />
                            {/* Search Button */}
